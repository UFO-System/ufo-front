    ...
    <div className="app">
      ...
      <div className="menu">
        <h5>
          ...
          <Button className="btn" variant="contained" onClick={plus1}>
            {" "}
            +{" "}
          </Button>
        </h5>
      ...
      <div className="menu">
        <h5>
          ...
          <Button className="btn" variant="contained" onClick={plus2}>
            {" "}
            +{" "}
          </Button>
        </h5>
      ...
      <div className="menu">
        <h5>
          ...
          <Button className="btn" variant="contained" onClick={plus3}>
            {" "}
            +{" "}
          </Button>
        </h5>
